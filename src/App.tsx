...
function App() {
  ...
  const [interval, setInterval] = useState<string>('1 минута')
  ...
  const getIntervalMs = (intervalString: string): number => {
    switch (intervalString) {
      case '1 минута': return 60 * 1000;
      case '5 минут': return 5 * 60 * 1000;
      case '10 минут': return 10 * 60 * 1000;
      case '30 минут': return 30 * 60 * 1000;
      case '1 час': return 60 * 60 * 1000;
